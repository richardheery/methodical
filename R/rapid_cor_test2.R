...
#' #' @param min_proportion_complete_pairs The minimum proportion of complete pairs required to return a p-value for a correlation.
#' #' Correlations with less than this proportion are given a p-value of NaN. Default value is 0.5. 
...
#' #' head(cor_results)
#' #'
#' rapidCorTest <- function(table1, table2, cor_method = "pearson", table1_name = "table1", table2_name = "table2", 
#'   p_adjust_method = "BH", n_covariates = 0, min_proportion_complete_pairs = 0.5){
#'   
...
#'   df <- n - 2 - n_covariates
#'   
#'   # Set the degrees of freedom for correlations where proportion of complete pairs is less 
#'   # than min_proportion_complete_pairs to 0
#'   proportion_complete_pairs = n/nrow(table1)
#'   df[proportion_complete_pairs < min_proportion_complete_pairs] = 0
#'   
