...
tubb6_correlation_plot_chrom_coords = plot_meth_site_values(tubb6_cpg_meth_transcript_cors, 
  column_name = "cor", ylabel = "Spearman Correlation", 
...
tubb6_methodical_scores_plot = plot_methodical_scores(
...
tubb6_smoothed_methodical_scores_plot = plot_methodical_scores(
  meth_site_values = tubb6_cpg_meth_transcript_cors, p_value_threshold = NULL, 
...
tubb6_smoothed_methodical_scores_plot = plot_methodical_scores(meth_site_values = 
...
tubb6_tmrs = find_tmrs(correlation_df = tubb6_cpg_meth_transcript_cors, offset_length = 10, 
