...
the DTB_003 prostate metastastis sample. We indicate the sample we want to plot
with the `sample_name` parameter. 

```{r, eval=TRUE}
# Plot the methylation values along the GSTP1 gene body for one prostate metastastis sample.
