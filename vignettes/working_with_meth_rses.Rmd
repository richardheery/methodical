...
apc_cpg_methylation <- extractGRangesMethSiteValues(
  meth_rse = mcrpc_wgbs_hg38_chr11, genomic_regions = apc_start_site_region )
...
# Liftover mcrpc_wgbs_hg38_chr11 to tcga_wgbs_hg19
tcga_wgbs_hg19 <- liftoverMethRSE(meth_rse = mcrpc_wgbs_hg38_chr11, chain = hg38tohg19Chain, 
  remove_one_to_many_mapping = TRUE, permitted_target_regions = hg19_cpgs)

# Compare the dimensions of mcrpc_wgbs_hg38_chr11 and tcga_wgbs_hg19. 
...
extractGRangesMethSiteValues(mcrpc_wgbs_hg38_chr11, GRanges("chr1:921635"))[, 1:8]
